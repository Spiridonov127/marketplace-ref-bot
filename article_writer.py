...
def _build_single_prompt(p: Product, topic: str = "") -> str:
    ...
    return (
        ...
        "при выборе, как ей пользоваться или с чем сочетать. Суммарный объём "
        "всех абзацев вместе — не меньше 1000 символов (примерно 150-180 слов), "
        "лучше чуть больше, чем меньше."
    )
